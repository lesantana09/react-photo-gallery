...
import { Dialog, DialogTrigger, DialogContent, DialogHeader, DialogBody, DialogFooter, DialogClose } from "./components/dialog";
...
export default function App() {
	...
	const ImageFileSource = file?.[0] ? URL.createObjectURL(file[0]) : undefined;
			...
			<div>
				<Dialog>
					...
					<DialogContent>
						...
						<DialogBody>
							<Text as="div" className="mb-4">Conteúdo da modal</Text>
							<InputSingleFile 
								form={form} 
								allowedFileTypes={['png', 'jpg', 'jpeg', 'webp']}
								maxFileSizeInMB={50}
